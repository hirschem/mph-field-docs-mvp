...
export default function NewBookPage() {
  ...
  const handleGenerate = () => {
    ...
    console.log("mode: book", "files:", fileNames);
  };
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans">
      <main className="flex flex-col items-center w-full max-w-2xl py-32 px-8 bg-white">
        ...
        <h2 className="text-2xl font-bold mb-6">Transcribe Book Page</h2>
        <input
          ref={fileInputRef}
          type="file"
          accept=".jpg,.jpeg,.png"
        ...
        />
        <button
          className="w-full py-4 text-xl bg-green-600 text-white rounded-lg font-semibold"
